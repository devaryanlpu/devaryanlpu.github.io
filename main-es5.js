...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        var currentUser = this.userService.isUser();
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(scriptService, router, authenticationService) {
    ...
    HomeComponent.prototype.calculate = function (i) {
        var item = this.bill.items[i];
        var totalPrice = item.unitPrice * item.qty;
        var taxAmount = totalPrice * item.tax / 100;
        var totalWithTax = totalPrice + taxAmount;
        this.bill.items[i].total = totalPrice;
        this.bill.items[i].taxAmount = taxAmount;
        this.bill.items[i].totalAmountWithTax = totalWithTax;
    };
    HomeComponent.prototype.generatePdf = function (action) {
    ...
    HomeComponent.prototype.getDocumentDefinition = function () {
    ...
    HomeComponent.prototype.getCustomerInfoObject = function (customerInfo) {
        var exs = [];
        exs.push([{
                columns: [
                    [{
    ...
    HomeComponent.prototype.getEducationObject = function (items) {
        return {
            table: {
    ...
    HomeComponent.prototype.getProfilePicObject = function () {
        if (this.bill.logo) {
            return {
    ...
    HomeComponent.prototype.addSkill = function () {
        this.bill.skills.push(new _bill__WEBPACK_IMPORTED_MODULE_2__["Skill"]());
    };
